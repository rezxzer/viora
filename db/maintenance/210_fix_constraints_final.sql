-- Fix Unique Constraints for Follow System

-- Check current constraints on follows table
SELECT 
...
-- Check current constraints on notifications table
SELECT 
...
-- Update the create_follow_notification function to handle conflicts properly
...
-- Test the constraints by trying to create duplicate follows
DO $$
DECLARE
  test_user1_id uuid;
  test_user2_id uuid;
